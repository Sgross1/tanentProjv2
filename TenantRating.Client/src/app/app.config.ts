...
import { TenantDashboardComponent } from "./features/tenant/tenant-dashboard/tenant-dashboard.component";
...
const routes: Routes = [
  ...
  {
    path: "tenant/wizard",
    component: TenantWizardComponent,
    canActivate: [authGuard],
  },
  {
    path: "landlord/search",
    component: LandlordSearchComponent,
    canActivate: [],
  },
  {
    path: "admin",
